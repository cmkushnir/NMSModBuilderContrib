...
public class _bInventoryRebalance : cmk.NMS.Script.ModClass
{
	public static int SubstanceDefaultStackSizeNormal = 10000; // Stacksize of substances(Original 9999)
	public static int ProductDefaultStackSizeNormal	  = 50;  // Stacksize of products you can craft or buy(Original 1)
	public static int TechWidthNormal                 = 8; // Tech slots increase(Original 7)
	public static int TechHeightNormal                = 3; // Tech slots increase(Original 2)
	public static float RefundNormal                  = 1;
