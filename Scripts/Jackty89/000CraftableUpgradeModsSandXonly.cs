...
public class CraftableUpgradeModsSandXonly : cmk.NMS.Script.ModClass
{
    ...
    {
        SetLanguageText(LangId.English, CraftedFreighterModDescrId, "A crafted freighter upgrade. \nCan be re-deployed into your own capital ship to improve its <TECHNOLOGY>Technology<>.");
        SetLanguageText(LangId.French, CraftedFreighterModDescrId, "Une amélioration de cargo fabriqué. \nPeut être redéployée dans votre propre vaisseau amiral pour améliorer sa <TECHNOLOGY>Technologie<>.");
        SetLanguageText(LangId.Italian, CraftedFreighterModDescrId, "Un miglioramento per il mercantile. \nPuò essere utilizzato sulla propria ammiraglia per migliorarne l'<TECHNOLOGY>Tecnologia<>.");
        SetLanguageText(LangId.German, CraftedFreighterModDescrId, "Ein einsetzbares Frachter-Upgrade. \nKann in dein eigenes Hauptschiff wiedereingebaut werden, um dessen <TECHNOLOGY>Technologie<> zu verbessern.");
        SetLanguageText(LangId.Spanish, CraftedFreighterModDescrId, "Una mejora del carguero hecha a mano. \nSe puede volver a desplegar en tu propia nave principal para mejorar su <TECHNOLOGY>Tecnología<>.");
        SetLanguageText(LangId.Russian, CraftedFreighterModDescrId, "Модернизация грузового корабля. \nМожет быть переоборудована в ваш собственный капитальный корабль для улучшения его <TECHNOLOGY>Technology<>.");
        SetLanguageText(LangId.Polish, CraftedFreighterModDescrId, "Rozmieszczalne ulepszenie frachtowca. MoÅ¼na ponownie zainstalowaÄ na wÅasnym statku gÅównym, aby ulepszyÄ jego <TECHNOLOGY>technologie<>.");
        SetLanguageText(LangId.Dutch, CraftedFreighterModDescrId, "Een upgrade gemaakt voor een vlaggenschip. \nKan worden geïnstalleerd in je eigen vlaggenschip om de <TECHNOLOGY>Technologie<> te verbeteren.");
        SetLanguageText(LangId.Portuguese, CraftedFreighterModDescrId, "Uma atualização do cargueiro implementável. \nPode ser reimplementada na sua própria nave capital para melhorar o <TECHNOLOGY>Tecnologia<>.");
        SetLanguageText(LangId.LatinAmericanSpanish, CraftedFreighterModDescrId, "Una mejora del carguero hecha a mano. \nSe puede volver a desplegar en tu propia nave principal para mejorar su <TECHNOLOGY>Tecnología<>.");
        SetLanguageText(LangId.BrazilianPortuguese, CraftedFreighterModDescrId, "Uma atualização implantável de nave cargueira. \nPode ser reimplantada na sua nave capital para melhorar o <TECHNOLOGY>Tecnologia<> dela.");
        SetLanguageText(LangId.SimplifiedChinese, CraftedFreighterModDescrId, "可合成的貨船升級。 \n可以被移除及重新安裝於星際貨船上，以提升<TECHNOLOGY>科技元件<>效能。");
        SetLanguageText(LangId.TraditionalChinese, CraftedFreighterModDescrId, "可合成的貨船升級。 \n可以被移除及重新安裝於星際貨船上，以提升<TECHNOLOGY>科技元件<>效能。");
        SetLanguageText(LangId.TenCentChinese, CraftedFreighterModDescrId, "可合成的貨船升級。 \n可以被移除及重新安裝於星際貨船上，以提升<TECHNOLOGY>科技元件<>效能。");
        SetLanguageText(LangId.USEnglish, CraftedFreighterModDescrId, "A crafted freighter upgrade. \nCan be re-deployed into your own capital ship to improve its <TECHNOLOGY>Technology<>.");
        //SetLanguageText(LangId.Korean, CraftedFreighterModDescrId, "");
        //SetLanguageText(LangId.Japanese, CraftedFreighterModDescrId, "");
    }
}
