...
//[NMSScriptDisabled]  // todo: broken
public class Add_Product : cmk.NMS.Script.ModClass
{
	...
	protected void FOOD_SCHIPS( List<GcProductData> PRODUCTS )
	{
		...
		product.Icon.Filename = "TEXTURES/UI/FRONTEND/ICONS/UPDATE3/TRADEPROD.MINERALS4.DDS";
	...
	// craft mix of 'chips' from activated star products, use as ingredient to make cookies
	...
	protected void FOOD_SCHIPCOOK( List<GcProductData> PRODUCTS, List<GcConsumableItem> CONSUMABLES )
	{
		...
		product.Icon.Filename = "TEXTURES/UI/FRONTEND/ICONS/COOKINGPRODUCTS/PRODUCT.REFINED.OMLETTE.DDS";
		product.CraftAmountMultiplier = 10;
		product.EggModifierIngredient = false;
		PRODUCTS.Add(product);
	...
	// cook cookies from mix of activated star 'chips'
	protected void FOOD_SCHIPCOOKA( List<GcProductData> PRODUCTS, List<GcConsumableItem> CONSUMABLES )
	{
		...
		product.Icon.Filename = "TEXTURES/UI/FRONTEND/ICONS/COOKINGPRODUCTS/PRODUCT.REFINED.TART.DDS";
		product.CraftAmountMultiplier = 10;
		product.EggModifierIngredient = false;
		PRODUCTS.Add(product);
