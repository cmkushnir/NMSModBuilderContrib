...
public class Export_Substances: cmk.NMS.Script.QueryClass
{
	protected override void Execute()
	{
		var save_path = Dialog.SaveFile(null, "Export_Substances.log");
	...
	{
		foreach( var substance in Game.PCBANKS.Substances ) {
